  ...
  return (
    <div className="bg-black min-h-screen w-screen text-xl flex flex-col justify-center items-center px-4 md:px-20">
      <div className="w-full min-h-full py-20 md:py-40 flex flex-col md:flex-row justify-center items-start space-y-8 md:space-y-0 md:space-x-8">
        <div className="w-full md:w-1/2 flex flex-col flex-grow">
          <div className="w-full flex flex-col flex-grow">
            <div className="w-full flex-col flex space-y-2 m-4">
              <div className="text-[#FFE900] text-2xl font-semibold mx-4 md:mx-12 mb-4">
                0.3 北車店
              </div>
            ...
            <div className="w-4/5 h-64 md:h-[300px] flex-col flex justify-center space-y-2 m-4 md:mx-12 mt-4 md:mt-0">
              <iframe
